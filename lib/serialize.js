...
module.exports = async (messages, sock, store) => {
  ...
  m.reply = async (text, options = {}) => {
    const time = parseInt(require("moment-timezone").tz(config.tz).format("HH"));    
    let res = "Selamat petang 🌆";
    if (time >= 4 && time < 10) {
        res = "Selamat pagi 🌄";
        ...
        m.cht,
        {
          ...
          contextInfo: {
             ...
             forwardedNewsletterMessageInfo: {
                ...
                newsletterName: `ᴘɪɴɢ: ${Date.now() - m.timestamps} ᴍs || ${Func.Styles(res)}`
             },
             externalAdReply: {
                mediaType: 1,
                mediaUrl: "https://whatsapp.com/channel/0029VaOQ0f3BA1f7HHV9DV1J",
                body: "© MchaX-Bot | Playground",
                thumbnailUrl: "https://files.catbox.moe/gyjtcu.jpg",
